...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Quick3D" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Quick3D_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Quick3D)
    ...
    macro(_populate_Quick3D_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Quick3D_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Quick3D_check_file_exists(${imported_location})
