...
static const struct imx_pll14xx_rate_table imx8mp_videopll_tbl[] = {
	...
	PLL_1443X_RATE(1008000000U, 168, 2, 1, 0),
...
static int imx8mp_clocks_probe(struct platform_device *pdev)
{
	...
	clk_prepare_enable(clks[IMX8MP_CLK_MEDIA_DISP1_PIX_ROOT]);
	clk_prepare_enable(clks[IMX8MP_CLK_MEDIA_MIPI_PHY1_REF]);
	clk_prepare_enable(clks[IMX8MP_CLK_MEDIA_DISP2_PIX_ROOT]);
	clk_prepare_enable(clks[IMX8MP_CLK_MEDIA_LDB_ROOT]);
	clk_prepare_enable(clks[IMX8MP_CLK_MEDIA_APB_ROOT]);
	clk_prepare_enable(clks[IMX8MP_CLK_MEDIA_AXI_ROOT]);
